    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<ActionResult<CategoryDto>> CreateCategoryAsync([FromBody] CategoryCreateUpdateDto categoryCreateDto)
        {
            ...
            try
            {
                ...
                return CreatedAtRoute("GetCategoryAsync",               //Parametro 1: nombre de la ruta
                    new {id = createdCategory.Id},                     //Parametro 2: los valores de los parametros de la ruta
                    createdCategory                                   //Parametro 3: El objeto creado
                    );
            }
        ...
        public async Task<ActionResult> DeleteCategoryAsync(int id)
        {
            ...
            try
            {
                ...
                return Ok(deletedCategory); //Retorno un OK para mostrarel "True" de la eliminación
            }
            catch (InvalidOperationException ex) when (ex.Message.Contains("No se encontró"))
            {
                return NotFound(new { ex.Message });
